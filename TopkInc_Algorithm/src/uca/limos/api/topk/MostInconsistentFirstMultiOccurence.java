...
public class MostInconsistentFirstMultiOccurence extends Results{
...
//	}
	...
	public MostInconsistentFirstMultiOccurence() {
...
//	}
	...
	public static MostInconsistentFirstMultiOccurence loadConfigure() {
		MostInconsistentFirstMultiOccurence loadConfigure = new MostInconsistentFirstMultiOccurence();
			try {
...
//				loadConfigure.setPredicates(DatasetConfig.predicate);
	...
	public static void loadLattices(MostInconsistentFirstMultiOccurence conf) throws SQLException {
		long dc  = 0;
