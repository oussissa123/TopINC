...
public class MostConsistentFirstMultiOccurence extends Results{
...
//				loadConfigure.setPredicates(DatasetConfig.predicate);
	...
	public void algorithm() throws Exception {
			...
			pw = new PrintWriter("queries_"+DatasetConfig.schema+"_"+k+".sql");
			pw.println("------- "+k+" -------------");
...
//		System.out.println(query);
		pw.println("EXPLAIN (ANALYZE, BUFFERS, FORMAT json) "+query+";");
