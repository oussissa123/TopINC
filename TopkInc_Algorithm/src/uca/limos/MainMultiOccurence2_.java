...
import uca.limos.api.topk.MostInconsistentFirstMultiOccurence;

public class MainMultiOccurence2_ {
...
private static Resource execute_semi(int k) {
	...
	try {
		...
		for(int e=0;e<step;e++) {
			MostInconsistentFirstMultiOccurence settop = MostInconsistentFirstMultiOccurence.loadConfigure();
			settop.setK(k);
			settop.algorithm();
...
//				mem = settop.getSizeInKo();
				bb = false;
				settop.save("statistiques_multi.csv");
			}
